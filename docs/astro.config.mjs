				...
				},
				{
					...
					items: [
						...
						},
						{
							...
							collapsed: true,
							items: [
								{ label: 'setup-moderation', link: '/commands/setup-moderation' },
								{ label: 'warn', link: '/commands/warn' },
								{ label: 'kick', link: '/commands/kick' },
								{ label: 'ban', link: '/commands/ban' },
								{ label: 'unban', link: '/commands/unban' },
								{ label: 'mute', link: '/commands/mute' },
								{ label: 'unmute', link: '/commands/unmute' },
								{ label: 'lock', link: '/commands/lock' },
								{ label: 'unlock', link: '/commands/unlock' },                                { label: 'slowmode', link: '/commands/slowmode' },
                                { label: 'strike', link: '/commands/strike' },
                                { label: 'softban', link: '/commands/softban' },
                                { label: 'modhistory', link: '/commands/modhistory' },
                                { label: 'warnlist', link: '/commands/warnlist' },
								{ label: 'note', link: '/commands/note' },
								{ label: 'reason', link: '/commands/reason' },
								{ label: 'appeal', link: '/commands/appeal' },
								{ label: 'pardon', link: '/commands/pardon' },
							],
						},
					],
				},
