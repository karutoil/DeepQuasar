const renameHandler = require('../handlers/tempvc/renameHandler');
const userLimitHandler = require('../handlers/tempvc/userLimitHandler');
const bitrateHandler = require('../handlers/tempvc/bitrateHandler');
const regionHandler = require('../handlers/tempvc/regionHandler');
const lockHideHandlers = require('../handlers/tempvc/lockHideHandlers');
const kickHandlers = require('../handlers/tempvc/kickHandlers');
const banUnbanHandlers = require('../handlers/tempvc/banUnbanHandlers');
const permissionManagementHandlers = require('../handlers/tempvc/permissionManagementHandlers');
const transferHandler = require('../handlers/tempvc/transferHandler');
const deleteResetHandlers = require('../handlers/tempvc/deleteResetHandlers');
const menuHandler = require('../handlers/tempvc/menuHandler');
