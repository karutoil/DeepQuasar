...
async function deployCommands(client) {
    try {
        ...
        // Fallback to old deployment method if smart deployment fails
        client.logger.info('🔄 Falling back to legacy deployment...');
        return await legacyDeployCommands(client);
    }
}
